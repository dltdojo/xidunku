...
struct Opt {
    ...
    #[structopt(short, long, default_value = "127.0.0.1:10443")]
    listen: SocketAddr,
...
fn main() -> std::io::Result<()> {
    ...
    println!("xctixweb start at https://{}", opt.listen.to_string());
    println!("or https://server-xidunku-127-0-0-1.nip.io:10443/docs/index.html");
